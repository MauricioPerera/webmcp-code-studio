# Base de Conocimiento de WebMCP Code Studio

Bienvenido al índice central de la base de conocimiento de **WebMCP Code Studio**, estructurado según el estándar **Open Knowledge Format (OKF)** y la metodología **KDD (Knowledge-Driven Development)**.

## 1. Arquitectura
- [Visión General de la Arquitectura](./architecture/overview.md)
- [Diseño del Virtual File System (VFS)](./architecture/vfs-design.md)
- [Integración WebMCP y fastwebmcp](./architecture/webmcp-integration.md)
